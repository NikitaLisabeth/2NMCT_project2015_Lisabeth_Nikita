...
public class TheatreListFragment  extends ListFragment implements LoaderManager.LoaderCallbacks<Cursor>  {
    ...
    public void onListItemClick(ListView l, View v, int position, long id) {
        ...
        Cursor c = (Cursor) mAdapter.getItem(position);
        String selectedClub = c.getString(c.getColumnIndex(Contract.TheatreColumns.COLUMN_THEATRE_NAME));
        if(onTheatresFragmentListener != null){
            onTheatresFragmentListener.onSelectTheatre(selectedClub);
        }
    }
